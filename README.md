...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/hgnc_get_gene \
  -H 'Content-Type: application/json' \
  -d '{"symbol":"BRCA1"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/hgnc_get_gene`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
